#############################################################################
# Makefile for building: Ruler
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ?? 29 20:02:39 2013
# Project:  Ruler.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -o Makefile Ruler.pro
#############################################################################
...
Makefile: Ruler.pro  c:\Qt\4.8.4\mkspecs\default\qmake.conf c:\Qt\4.8.4\mkspecs\qconfig.pri \
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) ".\Ruler.intermediate.manifest"
	-$(DEL_FILE) Ruler.exp
	-$(DEL_FILE) Ruler.ilk
	-$(DEL_FILE) vc*.pdb
	-$(DEL_FILE) vc*.idb
